---
title: Segmentos sugeridos (versión preliminar)
...
Como usuario de Customer Insights es probable que tenga una serie de [medidas creadas](measures.md) que ayuden a realizar un seguimiento de sus indicadores clave de rendimiento (KPI). Es importante comprender cómo ciertos atributos influyen en este KPI para crear segmentos y ejecutar una campaña altamente dirigida.   
