...
> - Necesita permisos de administrador para que su inquilino de Azure cree una entidad de servicio.
...
6. Si no se devuelve ningún resultado, puede [crear una nueva entidad de servicio](#create-a-new-service-principal). En la mayoría de los casos, ya existe y solo tiene que conceder permisos para que la entidad de servicio acceda a la cuenta de almacenamiento.
