...
ms.locfileid: "8647599"
---
# <a name="map-entities-and-attributes"></a>Correlacionar entidades y atributos

La **asignación** es la primera etapa del proceso de unificación de datos. La asignación consta de tres fases:
