...
Las predicciones se actualizarán automáticamente en la misma [programación que actualizan sus datos](schedule-refresh.md) definida en la configuración. También puede actualizarlas manualmente.
